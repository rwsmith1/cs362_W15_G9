...
INSERT INTO Appointment (fkUser, fkStudent, time, date, location, canceled) VALUES 
  ((SELECT pkUser FROM User WHERE name = 'user1' ),(SELECT pkStudent FROM Student WHERE name = 'student2'), 132, '2015-02-11', 'online', 0),
  ((SELECT pkUser FROM User WHERE name = 'user2' ),(SELECT pkStudent FROM Student WHERE name = 'student2'), 132, '2015-12-12', 'Kevins House', 0),
  ((SELECT pkUser FROM User WHERE name = 'user3' ),(SELECT pkStudent FROM Student WHERE name = 'student1'), 132, '2015-02-14', 'OSU', 0);
